...
const transitions: Record<OrderStatus, ReadonlySet<OrderStatus>> = {
  PENDING_SUBMIT: new Set(["PENDING_SUBMIT", "SUBMITTED", "PARTIALLY_FILLED", "FILLED", "CANCEL_PENDING", "CANCELLED", "REJECTED", "EXPIRED", "UNKNOWN_RECONCILIATION"]),
  ...
  CANCEL_PENDING: new Set(["CANCEL_PENDING", "CANCELLED", "FILLED", "EXPIRED", "UNKNOWN_RECONCILIATION"]),
